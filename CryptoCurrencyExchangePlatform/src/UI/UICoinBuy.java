...
public class UICoinBuy extends javax.swing.JFrame {
    ...
    public UICoinBuy(String coinName, double coinPrice) {
        ...
        Map<String,Coin> amountMap=CoinMarket.trader.getSpotWallet();
        if(amountMap.get(coinName)!=null){
            coinAmount.setText(Integer.toString(amountMap.get(coinName).getCoinAmountUserHas()));
        }else{
    ...
    private void BuyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuyButtonActionPerformed
        ...
        try{
            ...
            coinAmount.setText(Integer.toString(CoinMarket.trader.getSpotWallet().get(coinName).getCoinAmountUserHas()));
            jTextField1.setText("");
        }else{
    ...
    private void SellButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SellButtonActionPerformed
        // TODO add your handling code here:
        try{
            if(Integer.parseInt(jTextField1.getText())<=CoinMarket.trader.getSpotWallet().get(jLabel1.getText()).getCoinAmountUserHas()){
