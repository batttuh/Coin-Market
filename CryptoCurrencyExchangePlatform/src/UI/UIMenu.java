...
public class UIMenu extends javax.swing.JFrame {
    ...
    public UIMenu() {
        ...
        Map<String,Coin> coinsTable=CoinMarket.trader.getSpotWallet();
        for(Map.Entry<String, Coin> entry : coinsTable.entrySet()){
            jComboBox1.addItem(entry.getKey());
            spotBalance += entry.getValue().getPrice() * entry.getValue().getCoinAmountUserHas();
           
        }
        spotBalance = (int) spotBalance;
        estimatedValue += spotBalance + CoinMarket.trader.getFiat();
        transferMessage.setVisible(false); 
        
        jLabel13.setText(Double.toString(estimatedValue));
        spotBalanceLabel.setText(Double.toString(spotBalance));
        jLabel21.setText(Double.toString(CoinMarket.trader.getFiat()));
        creatingTableForCoins();
        creatingTableForTrader();
    }
    ...
    private void initComponents() {
        ...
        spotBalanceLabel = new javax.swing.JLabel();
        ...
        spotBalanceLabel.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        spotBalanceLabel.setForeground(new java.awt.Color(12, 242, 3));
        spotBalanceLabel.setText("150.120");
        ...
        jTable5.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Amount", "Total", "24h change", "24h volume", "Market Capacity"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.Long.class, java.lang.Long.class, java.lang.Long.class, java.lang.Long.class, java.lang.Long.class
            };
    ...
    private void verifyTransactionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_verifyTransactionActionPerformed
       ...
       try{
            if(CoinMarket.trader.getSpotWallet().get(jComboBox1.getSelectedItem().toString()).getCoinAmountUserHas()>=Integer.parseInt(coinAmount.getText())){
    ...
    private void logoutButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_logoutButtonMouseClicked
        CoinMarket coinMarket = new CoinMarket();
        coinMarket.logOut();
        UILoginPage uiLoginPage = new UILoginPage();
        uiLoginPage.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_logoutButtonMouseClicked
    private void creatingTableForCoins(){
    ...
    private void creatingTableForTrader(){
        spotBalance=0;
        estimatedValue=0;
        DefaultTableModel model1=(DefaultTableModel)jTable5.getModel();    
        model1.setRowCount(0);
        Map<String,Coin> traderSpotWallet=coinMarket.trader.getSpotWallet();
        for(Map.Entry<String, Coin> entry : traderSpotWallet.entrySet()) {
        String key = entry.getKey();
        int amount = entry.getValue().getCoinAmountUserHas();       
        spotBalance += entry.getValue().getPrice() * (double) entry.getValue().getCoinAmountUserHas();
        model1.addRow(new Object[]{key,amount,coinMarket.trader.getSpotWallet().get(key).getPrice()*amount,traderSpotWallet.get(key).getChanges(),traderSpotWallet.get(key).getVolume(),traderSpotWallet.get(key).getCapacity()});
       } 
        estimatedValue += spotBalance + CoinMarket.trader.getFiat();
        spotBalanceLabel.setText(Double.toString(spotBalance));
        jLabel13.setText(Double.toString(estimatedValue));
    ...
    private javax.swing.JLabel spotBalanceLabel;
